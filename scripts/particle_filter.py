...
class ParticleFilter:
    ...
    def update_particle_weights_with_measurement_model(self, data):
        for particle in self.particle_cloud:
            q = 1
            ang = euler_from_quaternion([particle.pose.orientation.x, particle.pose.orientation.y, particle.pose.orientation.z, particle.pose.orientation.w])[2]
            for i in range(360):
                z = data.ranges[i]
                ...
                q *= self.z_hit * compute_prob_zero_centered_gaussian(dist, self.sigma) + self.z_random / self.z_max
            particle.w = q
